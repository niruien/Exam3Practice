...
def run_test_zero_changer():
    ...
    # ------------------------------------------------------------------
    test2 = ([8, 0, 0, 9], [77, 0, 0, 1, 5, 0], [4, 0, 4], [4, 0, 4])
    expected2 = ([8, 1, 2, 9], [77, 3, 4, 1, 5, 5], [4, 6, 4], [4, 7, 4])
    zero_changer(test2)
    print()
    print('Test 2:')
    ...
    test3 = ([8, 0, 0, 9], [77, 0, 0, 1, 5, 0], [4, 0, 4], [4, 0, 0])
    expected3 = ([8, 1, 2, 9], [77, 3, 4, 1, 5, 5], [4, 6, 4], [4, 7, 8])
    zero_changer(test3)
    print()
    print('Test 3:')
